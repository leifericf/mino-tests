  ...
  (let [sizes [65536 262144]
        ...
        (mapv (fn [sz]
                ...
                (let [r (run-in-mino [["MINO_GC_NURSERY_BYTES" sz]
                                      ["MINO_TEST_EXCLUDE"
                                       "json_perf_test,regex_perf_test,string_perf_test,reduce_perf_test,csv_perf_test,toml_perf_test,yaml_perf_test,html_perf_test,xml_perf_test,html_fuzz_test,xml_fuzz_test,compress_perf_test"]]
